...
class FacultyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.home -> {
                    Toast.makeText(this@FacultyActivity, "Home Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.notes -> {
                    Toast.makeText(this@FacultyActivity, "Notes Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.profile -> {
                    Toast.makeText(this@FacultyActivity, "Profile Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.setting -> {
                    Toast.makeText(this@FacultyActivity, "Setting Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.logout -> {
                    Toast.makeText(this@FacultyActivity, "Logout Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.contact -> {
                    Toast.makeText(this@FacultyActivity, "Contact Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.suggestions -> {
                    Toast.makeText(this@FacultyActivity, "Suggestion Selected", Toast.LENGTH_SHORT).show()
                }

                R.id.rate -> {
                    Toast.makeText(this@FacultyActivity, "Rate Selected", Toast.LENGTH_SHORT).show()
                }
            }
            true
        })
