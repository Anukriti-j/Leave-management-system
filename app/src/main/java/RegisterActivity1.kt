...
//                Toast.makeText(this@RegisterActivity1, "Password is weak", Toast.LENGTH_SHORT)
//                    .show()
//
//            }
...
//                Toast.makeText(
//                    this@RegisterActivity1,
//                    "Password does not match, re-enter it!",
//                    Toast.LENGTH_SHORT
//                ).show()
//            }
            else {
                    ...
                    if (result.isSuccessful) {
                        ...
                        Firebase.firestore.collection("user")
                            ...
                            .addOnSuccessListener {
                                ...
                                Toast.makeText(this@RegisterActivity1, "Failed to create user", Toast.LENGTH_SHORT).show()
                            }
                    }
                }
            }
